...
public class PokeCraftBlocks {
    ...
    //          Building Blocks
    //Wood Types
    public static final Block DREAD_LOG = blockItem("dread_log", new Block(BlockBehaviour.Properties.of(Material.WOOD)), PokeCraftCreativeTabs.BUILDING_BLOCKS);
    ...
    public static final Block STRIPPED_DREAD_LOG = blockItem("stripped_dread_log", new Block(BlockBehaviour.Properties.of(Material.WOOD)), PokeCraftCreativeTabs.BUILDING_BLOCKS);
    ...
    //RedstoneLamp
    public static final Block WHITE_REDSTONE_LAMP = blockItem("white_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block LIGHT_GRAY_REDSTONE_LAMP = blockItem("light_gray_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block GRAY_REDSTONE_LAMP = blockItem("gray_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block BLACK_REDSTONE_LAMP = blockItem("black_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block BROWN_REDSTONE_LAMP = blockItem("brown_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block RED_REDSTONE_LAMP = blockItem("red_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block ORANGE_REDSTONE_LAMP = blockItem("orange_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block YELLOW_REDSTONE_LAMP = blockItem("yellow_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block LIME_REDSTONE_LAMP = blockItem("lime_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block GREEN_REDSTONE_LAMP = blockItem("green_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block CYAN_REDSTONE_LAMP = blockItem("cyan_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block LIGHT_BLUE_REDSTONE_LAMP = blockItem("light_blue_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block BLUE_REDSTONE_LAMP = blockItem("blue_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block PURPLE_REDSTONE_LAMP = blockItem("purple_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block MAGENTA_REDSTONE_LAMP = blockItem("magenta_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    public static final Block PINK_REDSTONE_LAMP = blockItem("pink_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.COLORED_BLOCKS);
    //Glowstone
