...
public class PokeCraftItems {
    ...
    public static final Item BLANK_PLATE = register("blank_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item DRACO_PLATE = register("draco_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item DREAD_PLATE = register("dread_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item EARTH_PLATE = register("earth_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item FIST_PLATE = register("fist_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item FLAME_PLATE = register("flame_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item ICICLE_PLATE = register("icicle_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item INSECT_PLATE = register("insect_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item IRON_PLATE = register("iron_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item MEADOW_PLATE = register("meadow_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item MIND_PLATE = register("mind_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item PIXIE_PLATE = register("pixie_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item SKY_PLATE = register("sky_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item SPLASH_PLATE = register("splash_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item SPOOKY_PLATE = register("spooky_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item STONE_PLATE = register("stone_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item TOXIC_PLATE = register("toxic_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    public static final Item ZAP_PLATE = register("zap_plate", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.HELD_ITEMS);
    ...
    public static final Item BUG_MEMORY = register("bug_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item DARK_MEMORY = register("dark_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item DRAGON_MEMORY = register("dragon_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item ELECTRIC_MEMORY = register("electric_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item FAIRY_MEMORY = register("fairy_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item FIGHTING_MEMORY = register("fighting_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item FIRE_MEMORY = register("fire_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item FLYING_MEMORY = register("flying_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item GHOST_MEMORY = register("ghost_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item GRASS_MEMORY = register("grass_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item GROUND_MEMORY = register("ground_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item ICE_MEMORY = register("ice_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item POISON_MEMORY = register("poison_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item PSYCHIC_MEMORY = register("psychic_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item ROCK_MEMORY = register("rock_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item STEEL_MEMORY = register("steel_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    public static final Item WATER_MEMORY = register("water_memory", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    ...
    public static final Item MYSTERIOUS_BALM = register("mysterious_balm", new Item(SINGLE_PROPERTIES), PokeCraftCreativeTabs.SPECIAL);
    ...
    // Gimmick Items
    public static final Item ALORAICHIUM_Z = register("aloraichium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item BUGINIUM_Z = register("buginium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item DARKINIUM_Z = register("darkinium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item DECIDIUM_Z = register("decidium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item DRAGONIUM_Z = register("dragonium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item EEVIUM_Z = register("eevium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item ELECTRIUM_Z = register("electrium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item FAIRIUM_Z = register("fairium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item FIGHTINIUM_Z = register("fightinium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item FIRIUM_Z = register("firium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item FLYINIUM_Z = register("flyinium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item GHOSTIUM_Z = register("ghostium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item GRASSIUM_Z = register("grassium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item GROUNDIUM_Z = register("groundium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item ICIUM_Z = register("icium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item INCINIUM_Z = register("incinium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item KOMMONIUM_Z = register("kommonium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item LUNALIUM_Z = register("lunalium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item LYCANIUM_Z = register("lycanium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item MARSHADIUM_Z = register("marshadium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item MEWNIUM_Z = register("mewnium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item MIMIKUIM_Z = register("mimikium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item NORMALIUM_Z = register("normalium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item PIKANIUM_Z = register("pikanium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item PIKASHUNIUM_Z = register("pikashunium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item POISONIUM_Z = register("poisonium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item PRIMARIUM_Z = register("primarium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item PSYCHIUM_Z = register("psychium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item ROCKIUM_Z = register("rockium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item SNORLIUM_Z = register("snorlium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item SOLGANIUM_Z = register("solganium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item STEELIUM_Z = register("steelium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item TAPUNIUM_Z = register("tapunium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item ULTRANECROZIUM_Z = register("ultranecrozium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item WATERIUM_Z = register("waterium_z", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.Z_CRYSTALS);
    public static final Item BUG_TERA_SHARD = register("bug_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item DARK_TERA_SHARD = register("dark_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item DRAGON_TERA_SHARD = register("dragon_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item ELECTRIC_TERA_SHARD = register("electric_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item FAIRY_TERA_SHARD = register("fairy_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item FIGHTING_TERA_SHARD = register("fighting_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item FIRE_TERA_SHARD = register("fire_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item FLYING_TERA_SHARD = register("flying_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item GHOST_TERA_SHARD = register("ghost_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item GRASS_TERA_SHARD = register("grass_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item GROUND_TERA_SHARD = register("ground_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item ICE_TERA_SHARD = register("ice_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item NORMAL_TERA_SHARD = register("normal_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item POISON_TERA_SHARD = register("poison_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item PSYCHIC_TERA_SHARD = register("psychic_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item ROCK_TERA_SHARD = register("rock_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item STEEL_TERA_SHARD = register("steel_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item WATER_TERA_SHARD = register("water_tera_shard", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item ABOMASITE = register("abomasite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item ABSOLITE = register("absolite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item AERODACTYLITE = register("aerodactylite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item AGGRONITE = register("aggronite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item ALAKAZITE = register("alakazite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item ALTARIANITE = register("altarianite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item AMPHAROSITE = register("ampharosite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item AUDINITE = register("audinite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item BANETTITE = register("banettite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item BEEDRILLITE = register("beedrillite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item BLASTOISINITE = register("blastoiseinite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item BLAZIKENITE = register("blazikenite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item CAMERUPTITE = register("cameruptite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item CHARIZARDITE_X = register("charizardite_x", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item CHARIZARDITE_Y = register("charizardite_y", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item DIANCITE = register("diancite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item GALLADITE = register("galladite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item GARCHOMPITE = register("garchompite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item GARDEVOIRITE = register("gardevoirite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item GENGARITE = register("gengarite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item GLALITITE = register("glalitite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item GYARADOSITE = register("gyaradosite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item HERACRONITE = register("heracronite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item HOUNDOOMINITE = register("houndoominite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item KANGASKHANITE = register("kangaskhanite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item LATIASITE = register("latiasite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item LATIOSITE = register("latiosite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item LOPUNNITE = register("lopunnite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item LUCARIONITE = register("lucarionite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item MANECTITE = register("manectite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item MAWILITE = register("mawilite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item MEDICHAMITE = register("medichamite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item METAGROSSITE = register("metagrossite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item MEWTWONITE_X = register("mewtwonite_x", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item MEWTWONITE_Y = register("mewtwonite_y", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item PIDGEOTITE = register("pidgeotite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item PINSIRITE = register("pinsirite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item SABLENITE = register("sablenite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item SALAMENCITE = register("salamencite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item SCEPTILITE = register("sceptilite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item SCIZORITE = register("scizorite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item SHARPEDONITE = register("sharpedonite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item SLOWBRONITE = register("slowbronite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item STEELIXITE = register("steelixite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item SWAMPERTITE = register("swampertite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item TYRANITARITE = register("tyranitarite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    public static final Item VENUSAURITE = register("venusaurite", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.MEGA_STONES);
    ...
    public static final Item GALARICA_CROWN = register("galarica_crown", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.EVOLUTION_ITEMS);
    ...
    public static final Item ADRENALINE_ORB = register("adrenaline_orb", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    ...
    public static final Item CALCIUM = register("calcium", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item CARBOS = register("carbos", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item DIRE_HIT = register("dire_hit", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item DYNAMAX_CANDY = register("dynamax_candy", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item EXP_CANDY_L = register("exp_candy_l", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item EXP_CANDY_M = register("exp_candy_m", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item EXP_CANDY_S = register("exp_candy_s", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item EXP_CANDY_XL = register("exp_candy_xl", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item EXP_CANDY_XS = register("exp_candy_xs", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item CLEVER_FEATHER = register("clever_feather", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item GENIUS_FEATHER = register("genius_feather", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item HEALTH_FEATHER = register("health_feather", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item MUSCLE_FEATHER = register("muscle_feather", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item RESIST_FEATHER = register("resist_feather", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item SWIFT_FEATHER = register("swift_feather", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item FLUFFY_TAIL = register("fluffy_tail", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    ...
    public static final Item GUARD_SPEC = register("guard_spec", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item HP_UP = register("hp_up", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item IRON = register("iron", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    ...
    public static final Item POKE_DOLL = register("poke_doll", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item PP_MAX = register("pp_max", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item PP_UP = register("pp_up", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item PROTEIN = register("protein", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item RARE_CANDY = register("rare_candy", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item X_ACCURACY = register("x_accuracy", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item X_ATTACK = register("x_attack", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item X_DEFENSE = register("x_defense", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item X_SP_ATK = register("x_sp_atk", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item X_SP_DEF = register("x_sp_def", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item X_SPEED = register("x_speed", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    public static final Item ZINC = register("zinc", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.BATTLE_AND_STATS);
    ...
    public static final Item BALM_MUSHROOM = register("balm_mushroom", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    ...
    public static final Item FOSSILIZED_DRAKE = register("fossilized_dark", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    ...
    public static final Item HEART_SCALE = register("heart_scale", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item HONEY = register("honey", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item KEY_STONE = register("key_stone", new Item(SINGLE_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    ...
    public static final Item SLOWPOKE_TAIL = register("slowpoke_tail", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    ...
    public static final Item WISHING_PIECE = register("wishing_piece", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.NATURAL);
    public static final Item WISHING_STAR = register("wishing_star", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.NATURAL);

    // Player
    public static final Item BALL_OF_MUD = register("ball_of_mud", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item ESCAPE_ROPE = register("escape_rope", new Item(GENERIC_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item ETERNAL_ICE = register("eternal_ice", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item EXP_ALL = register("exp_all", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    ...
    public static final Item GREEN_FLUTE = register("green_flute", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    ...
    public static final Item POKE_TOY = register("poke_toy", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    ...
    public static final Item SANDWICH = register("sandwich", new Item(SINGLE_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    ...
    public static final Item SEED_OF_MASTERY = register("seed_of_mastery", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    ...
    public static final Item BUG_TM = register("bug_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item DARK_TM = register("dark_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item DRAGON_TM = register("dragon_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item ELECTRIC_TM = register("electric_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item FAIRY_TM = register("fairy_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item FIGHTING_TM = register("fighting_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item FIRE_TM = register("fire_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item FLYING_TM = register("flying_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item GHOST_TM = register("ghost_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item GRASS_TM = register("grass_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item GROUND_TM = register("ground_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item ICE_TM = register("ice_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item NORMAL_TM = register("normal_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item POISON_TM = register("poison_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item PSYCHIC_TM = register("psychic_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item ROCK_TM = register("rock_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item STEEL_TM = register("steel_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    public static final Item WATER_TM = register("water_tm", new Item(SIXTEEN_PROPERTIES), PokeCraftCreativeTabs.PLAYER_ITEMS);
    ...
    public static final Item GOOD_ROD = register("good_rod", new Item(SINGLE_PROPERTIES), PokeCraftCreativeTabs.KEY_ITEMS);
    public static final Item OLD_ROD = register("old_rod", new Item(SINGLE_PROPERTIES), PokeCraftCreativeTabs.KEY_ITEMS);
    public static final Item SUPER_ROD = register("super_rod", new Item(SINGLE_PROPERTIES), PokeCraftCreativeTabs.KEY_ITEMS);
