...
public class PokeCraftBlocks {
    ...
    public static final Block BAMBOO_CRAFTING_TABLE = blockItem("bamboo_crafting_table", new Block(BlockBehaviour.Properties.of(Material.WOOD)), PokeCraftCreativeTabs.BLOCKS);
...
// New
    ...
    public static final Block FOSSIL_ORE = blockItem("fossil_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block FOSSIL_DEEPSLATE_ORE = blockItem("fossil_deepslate_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block Z_CRYSTAL_ORE = blockItem("z_crystal_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block Z_CRYSTAL_DEEPSLATE_ORE = blockItem("z_crystal_deepslate_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block ORIGIN_ORE = blockItem("origin_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block ORIGIN_DEEPSLATE_ORE = blockItem("origin_deepslate_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block FIRE_STONE_ORE = blockItem("fire_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block FIRE_STONE_DEEPSLATE_ORE = blockItem("fire_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block FIRE_STONE_BLOCK = blockItem("fire_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block WATER_STONE_ORE = blockItem("water_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block WATER_STONE_DEEPSLATE_ORE = blockItem("water_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block THUNDER_STONE_ORE = blockItem("thunder_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block THUNDER_STONE_DEEPSLATE_ORE = blockItem("thunder_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block LEAF_STONE_ORE = blockItem("leaf_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LEAF_STONE_DEEPSLATE_ORE = blockItem("leaf_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LEAF_STONE_BLOCK = blockItem("leaf_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block MOON_STONE_ORE = blockItem("moon_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block MOON_STONE_DEEPSLATE_ORE = blockItem("moon_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block MOON_STONE_BLOCK = blockItem("moon_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block SUN_STONE_ORE = blockItem("sun_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block SUN_STONE_DEEPSLATE_ORE = blockItem("sun_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block SUN_STONE_BLOCK = blockItem("sun_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block SHINY_STONE_ORE = blockItem("shiny_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block SHINY_STONE_DEEPSLATE_ORE = blockItem("shiny_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block SHINY_STONE_BLOCK = blockItem("shiny_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block DUSK_STONE_ORE = blockItem("dusk_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block DUSK_STONE_DEEPSLATE_ORE = blockItem("dusk_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block DUSK_STONE_BLOCK = blockItem("dusk_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block DAWN_STONE_ORE = blockItem("dawn_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block DAWN_STONE_DEEPSLATE_ORE = blockItem("dawn_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block DAWN_STONE_BLOCK = blockItem("dawn_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block ICE_STONE_ORE = blockItem("ice_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block ICE_STONE_DEEPSLATE_ORE = blockItem("ice_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block ICE_STONE_BLOCK = blockItem("ice_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block OVAL_STONE_ORE = blockItem("oval_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block OVAL_STONE_DEEPSLATE_ORE = blockItem("oval_stone_ore", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block OVAL_STONE_BLOCK = blockItem("oval_stone_block", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block WHITE_SAND = blockItem("white_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block LIGHT_GRAY_SAND = blockItem("light_gray_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block GRAY_SAND = blockItem("gray_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block BLACK_SAND = blockItem("black_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block BROWN_SAND = blockItem("brown_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block YELLOW_SAND = blockItem("yellow_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block LIME_SAND = blockItem("lime_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block GREEN_SAND = blockItem("green_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block CYAN_SAND = blockItem("cyan_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block LIGHT_BLUE_SAND = blockItem("light_blue_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block BLUE_SAND = blockItem("blue_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block PURPLE_SAND = blockItem("purple_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block MAGENTA_SAND = blockItem("magenta_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block PINK_SAND = blockItem("pink_sand", new SandBlock(0xA95821, SAND), PokeCraftCreativeTabs.BLOCKS);
    ...
    // Prismarine
    public static final Block WHITE_PRISMARINE = blockItem("white_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block LIGHT_GRAY_PRISMARINE = blockItem("light_gray_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block GRAY_PRISMARINE = blockItem("gray_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block BLACK_PRISMARINE = blockItem("black_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block BROWN_PRISMARINE = blockItem("brown_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block RED_PRISMARINE = blockItem("red_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block ORANGE_PRISMARINE = blockItem("orange_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block YELLOW_PRISMARINE = blockItem("yellow_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block LIME_PRISMARINE = blockItem("lime_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block GREEN_PRISMARINE = blockItem("green_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block CYAN_PRISMARINE = blockItem("cyan_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block LIGHT_BLUE_PRISMARINE = blockItem("light_blue_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block BLUE_PRISMARINE = blockItem("blue_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block PURPLE_PRISMARINE = blockItem("purple_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block MAGENTA_PRISMARINE = blockItem("magenta_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    public static final Block PINK_PRISMARINE = blockItem("pink_prismarine", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    ...
    // Ultra Light
    public static final Block WHITE_ULTRA_LIGHT = blockItem("white_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LIGHT_GRAY_ULTRA_LIGHT = blockItem("light_gray_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block GRAY_ULTRA_LIGHT = blockItem("gray_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block BLACK_ULTRA_LIGHT = blockItem("black_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block BROWN_ULTRA_LIGHT = blockItem("brown_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block RED_ULTRA_LIGHT = blockItem("red_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block ORANGE_ULTRA_LIGHT = blockItem("orange_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block YELLOW_ULTRA_LIGHT = blockItem("yellow_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LIME_ULTRA_LIGHT = blockItem("lime_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block GREEN_ULTRA_LIGHT = blockItem("green_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block CYAN_ULTRA_LIGHT = blockItem("cyan_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LIGHT_BLUE_ULTRA_LIGHT = blockItem("light_blue_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block BLUE_ULTRA_LIGHT = blockItem("blue_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block PURPLE_ULTRA_LIGHT = blockItem("purple_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block MAGENTA_ULTRA_LIGHT = blockItem("magenta_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block PINK_ULTRA_LIGHT = blockItem("pink_ultra_light", new Block(BlockBehaviour.Properties.of(Material.STONE)), PokeCraftCreativeTabs.BLOCKS);



    // Glowstone
    public static final Block WHITE_GLOWSTONE = blockItem("white_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LIGHT_GRAY_GLOWSTONE = blockItem("light_gray_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block GRAY_GLOWSTONE = blockItem("gray_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block BLACK_GLOWSTONE = blockItem("black_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block BROWN_GLOWSTONE = blockItem("brown_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block RED_GLOWSTONE = blockItem("red_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block ORANGE_GLOWSTONE = blockItem("orange_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block YELLOW_GLOWSTONE = blockItem("yellow_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LIME_GLOWSTONE = blockItem("lime_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block GREEN_GLOWSTONE = blockItem("green_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block CYAN_GLOWSTONE = blockItem("cyan_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LIGHT_BLUE_GLOWSTONE = blockItem("light_blue_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block BLUE_GLOWSTONE = blockItem("blue_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block PURPLE_GLOWSTONE = blockItem("purple_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block MAGENTA_GLOWSTONE = blockItem("magenta_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block PINK_GLOWSTONE = blockItem("pink_glowstone", new Block(BlockBehaviour.Properties.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sound(SoundType.GLASS).lightLevel(blockState -> 15)), PokeCraftCreativeTabs.BLOCKS);



    // Redstone Lamp
    public static final Block WHITE_REDSTONE_LAMP = blockItem("white_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)), PokeCraftCreativeTabs.BLOCKS);
    public static final Block LIGHT_GRAY_REDSTONE_LAMP = blockItem("light_gray_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block GRAY_REDSTONE_LAMP = blockItem("gray_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block BLACK_REDSTONE_LAMP = blockItem("black_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block BROWN_REDSTONE_LAMP = blockItem("brown_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block RED_REDSTONE_LAMP = blockItem("red_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block ORANGE_REDSTONE_LAMP = blockItem("orange_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block YELLOW_REDSTONE_LAMP = blockItem("yellow_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block LIME_REDSTONE_LAMP = blockItem("lime_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block GREEN_REDSTONE_LAMP = blockItem("green_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block CYAN_REDSTONE_LAMP = blockItem("cyan_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block LIGHT_BLUE_REDSTONE_LAMP = blockItem("light_blue_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block BLUE_REDSTONE_LAMP = blockItem("blue_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block PURPLE_REDSTONE_LAMP = blockItem("purple_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block MAGENTA_REDSTONE_LAMP = blockItem("magenta_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
    public static final Block PINK_REDSTONE_LAMP = blockItem("pink_redstone_lamp", new RedstoneLampBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS).lightLevel(Blocks.litBlockEmission(15)).strength(0.3f).sound(SoundType.GLASS).isValidSpawn(Blocks::always)));
